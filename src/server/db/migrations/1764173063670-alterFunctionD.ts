...
export class AlterFunctionD1764173063670 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER FUNCTION public.sp_refreshstats_d(character varying, character varying) OWNER TO "default"`,
    )
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP FUNCTION IF EXISTS public.sp_refreshstats_d(character varying, character varying)`,
    )
  }
}
