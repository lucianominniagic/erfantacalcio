...
export const showStatisticaVotiORPCProcedure = publicProcedure
  .route({ method: 'GET', path: '/voti/getStatisticaVoti', summary: 'Statistiche voti per giornata di un giocatore' })
  .input(
    z.object({
